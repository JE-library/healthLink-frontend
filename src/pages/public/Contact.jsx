      ...
      <div className="bg-[#d1f4fa] text-gray-800 font-serif">
        ...
        <section className="grid md:grid-cols-2 gap-8 px-10 pb-16">
          <div className="bg-white p-8 rounded-xl shadow-md border border-[#005792]">
            ...
            <button className="bg-[#53cde2] text-white py-2 px-5 rounded-full hover:bg-[#d86660] transition duration-200">
              Talk to a doctor
            </button>
          </div>
        ...
        <section className="grid md:grid-cols-2 gap-10 px-10 pb-20">
          <form className="bg-white p-8 rounded-xl shadow-md">
            ...
            <button
              type="submit"
              className="bg-[#53cde2] text-white py-2 px-6 rounded-full hover:bg-[#d86660] transition"
            >
              Send
            </button>
          </form>
          ...
          <div>
            ...
            ></iframe>
            <h3 className="mt-4 font-bold text-lg">Our Location</h3>
            <p>Accra, Ghana</p>
          </div>
        </section>
      </div>
