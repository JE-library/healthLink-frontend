...
const Consultation = () => {
  ...
  useEffect(() => {
    const fetchConversation = async () => {
      try {
        const res = await axios.get(`/users/chats/${id}`);
  ...
  const specialist = conversation.serviceProvider;
  ...
  return (
    <div className=" sm:p-6 md:px-16 max-w-4xl mx-auto">
      ...
      <div
        ...
        onClick={() => navigate(`/patient/providers/${specialist._id}`)}
      >
        <img
          src={specialist?.profilePhoto?.url || "/default-avatar.png"}
